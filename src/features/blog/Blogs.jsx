...
export default function Blogs() {
  ...
  const [status, setStatus] = useState(true); // Used for filtering by status
  ...
  return (
    <StyledContainer>
      <FilterHeader>
        <FilterButton onClick={() => setStatus(true)} $active={status == true}>
          Active
        </FilterButton>
        <FilterButton onClick={() => setStatus(false)} $active={status == false}>
          Deactive
        </FilterButton>
      </FilterHeader>
            ...
            filteredByStatus.data.data.map((blog, index) => {
              return (
                <tr key={index}>
                  ...
                  <td>
                    {blog.interior_designer_id ? (
                      <EmailColumn>
                        ...
                        />
                        <div>
                          <span>{blog.interior_designer.first_name}</span>
                  ...
                  <td>{convertDate(blog.createdDate)}</td>
