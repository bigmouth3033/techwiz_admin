...
import { getAdminGalleriesRequest } from "./api/adminGalleriesApi";
...
import { changeGalleryStatusRequest } from "../update-gallery/api/updateGalleryApi";
...
export default function AdminGalleries() {
  ...
  const getAdminGalleries = getAdminGalleriesRequest(
    currentPage,
    10,
    filterStatus.value,
  ...
  return (
    <StyledContainer>
      ...
      <TableContent>
        ...
        <tbody>
          {getAdminGalleries.isSuccess &&
            getAdminGalleries.data.data.map((gallery, index) => {
              return (
                <tr key={index}>
                  <td>
                    <EmailColumn>
                  ...
                  <td>
                    {gallery.interior_designer_id ? (
                      <EmailColumn>
                        <Avatar
                          round
                          size="60"
                          name={gallery.interior_designer.first_name}
                          src={getFirebaseImageUrl(gallery.interior_designer.avatar)}
                        />
                        <div>
                          <CustomLink
                            to={"/designer_detail?id=" + gallery.interior_designer.user_id}
                          >
                            {gallery.interior_designer.first_name}
                          </CustomLink>
                          <span>
                            {gallery.interior_designer.yearsofexperience} Year of experience
                          </span>
                        </div>
                      </EmailColumn>
                    ) : (
                  ...
                  <td>
                    <Button2 onClick={() => onChangeGalleryStatus(gallery.id)}>
      ...
      <Footer>
        {getAdminGalleries.isSuccess && (
          <Pagination
            ...
            totalPage={getAdminGalleries.data.totalPages}
          />
        )}
      </Footer>
    </StyledContainer>
